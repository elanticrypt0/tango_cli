...
func FindOne$SC$(ctx echo.Context, tapp *tangoapp.TangoApp) error {
...
func FindAll$PC$(ctx echo.Context, tapp *tangoapp.TangoApp) error {
...
func Create$SC$(ctx echo.Context, tapp *tangoapp.TangoApp) error {
...
func Update$SC$(ctx echo.Context, tapp *tangoapp.TangoApp) error {
	id, _ := strconv.Atoi(ctx.Param("id"))
...
func Delete$SC$(ctx echo.Context, tapp *tangoapp.TangoApp) error {
	id, _ := strconv.Atoi(ctx.Param("id"))
	$FL$ := models.New$SC$()
